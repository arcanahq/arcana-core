...
contract DeployScript is Script {
    function run() external {
        ...
        // Deploy MockERC20 with 18 decimals to match the Arcana basic-app asset config.
        MockERC20 token = new MockERC20("Test USDC", "USDC", 18);
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            token.mint(recipients[i], 1_000_000 * 10 ** 18);
